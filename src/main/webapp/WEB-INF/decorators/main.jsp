...
<head>
    ...
    <link href="<s:url value='/vendor/fontawesome-free/css/all.min.css'/>" rel="stylesheet" type="text/css">
    <link href="<s:url value='/styles/sb-admin-2.css'/>" rel="stylesheet" type="text/css" media="all"/>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="/strutsproject_war_exploded/createPerson">
